...
void calc_G(const double *t, int N, const double *I_E, const double *tM,
            int n_meals, const double *taug, double B, double Cm, double toff,
...
void run_cma_model(const double *t, int N, double d, double taup,
                   ...
                   double eps, double *out_L, double *out_m, double *out_c,
